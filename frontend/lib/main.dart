...
import 'package:biofeedback/chart.dart';
...
class _MyHomePageState extends State<MyHomePage> with SingleTickerProviderStateMixin {
                          ...
                          child: Stack(
                            ...
                            children: <Widget>[
                              ...
                              Container(
                                ...
                                child: Text(
                                  _toggled ? "Cubra a camera e o flash com seu dedo" : "Visualização da camera",
                                  style: TextStyle(backgroundColor: _toggled ? Colors.white : Colors.transparent),
  ...
  void _clearData() {
    ...
    for (int i = 0; i < _windowLen; i++)
      _data.insert(0, HrvValue(DateTime.fromMillisecondsSinceEpoch(now - i * 1000 ~/ _fs), 128));
  }
  ...
  Future<void> _initController() async {
    try {
      ...
      _controller = CameraController(_cameras.first, ResolutionPreset.low, flashMode: FlashMode.torch);
  ...
  void _updateBPM() async {
    ...
    while (_toggled) {
      ...
      _n = _values.length;
      _m = 0;
      _values.forEach((HrvValue value) {
        _avg += value.value / _n;
